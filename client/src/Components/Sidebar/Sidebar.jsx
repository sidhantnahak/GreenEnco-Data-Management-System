...
const Sidebar = () => {
    ...
    return (
        ...
        <>
            ...
            <div id='open_links' onClick={(e) => e.stopPropagation()} style={{ width: width < 400 ? "unset" : "auto", display: dropdown ? "flex" : "none", position: "fixed", top: "65px", right: "5px", left: width < 400 && "5px", background: "rgb(43 50 66)", color: "white" }} className='px-5 py-2 gap-3 rounded'>
                <ul className='d-flex flex-column py-2 gap-1 align-items-center justify-content-center text-center'>
                    ...
                    <Link to="/contact6" className='text-white mt-1 text-decoration-none font-weight-bold' style={{ fontWeight: "600" }}>Contact</Link>
                </ul>
                <ul className='d-flex flex-column  py-2 gap-1 align-items-center justify-content-center text-center'>
